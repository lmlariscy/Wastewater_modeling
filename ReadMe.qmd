...
3.  Start by running the summary scripts (1_clinical_data_summary.Rmd and 2_wastewater_data_summary.Rmd) to generate summary stats (not necessary for downstream scripts)
