...
ap_recipe <- recipe(log10_cases ~ 
                A_N1_POS+A_N2_POS+B_N1_POS+B_N2_POS+C_N1_POS+C_N2_POS,
                data = data_n6_train)

vl_recipe <- recipe(log10_cases ~ A_N1+A_N2+B_N1+B_N2+C_N1+C_N2,
                       data = data_n6_train)

all_recipe <- recipe(log10_cases ~ A_N1_POS+A_N2_POS+B_N1_POS+B_N2_POS+C_N1_POS+C_N2_POS+
...
folds_ap_n6 <- vfold_cv(data_n6_train, 
                        v = 2, repeats = 20, strata = cases.reported)
...
aug_ap_n6 %>% ggplot(aes(cases.reported, .pred)) +
  geom_point() +
...
df_time <- aug_ap_n6 %>% ggplot(aes(x=week)) +
  geom_line(aes(y=cases.reported), color = "blue") +
...
aug_ap_n6_test %>% ggplot(aes(cases.reported, .pred)) +
  geom_point() +
  stat_smooth(method = "lm") 
...
aug_ap_n1 %>% ggplot(aes(cases.reported, .pred)) +
  geom_point() +
  stat_smooth(method = "lm")
...
df_n1_train <- aug_ap_n1 %>% ggplot(aes(x=week)) +
  ...
  geom_smooth(aes(y=cases.reported), method = "gam", color="blue") +
  ggthemes::theme_clean() +
...
aug_ap_n1_test %>% ggplot(aes(cases.reported, .pred)) +
  geom_point() +
  stat_smooth(method = "lm") 
...
aug_vl_n6 %>% ggplot(aes(cases.reported, .pred)) +
  geom_point() +
  stat_smooth(method = "lm")
...
aug_vl_n6_test %>% ggplot(aes(cases.reported, .pred)) +
  geom_point() +
  stat_smooth(method = "lm") 
...
aug_vl_n1 %>% ggplot(aes(cases.reported, .pred)) +
  geom_point() +
  stat_smooth(method = "lm") 
...
aug_vl_n1_test %>% ggplot(aes(cases.reported, .pred)) +
  geom_point() +
  stat_smooth(method = "lm")
