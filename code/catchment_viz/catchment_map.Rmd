...
wrf_plot = wrf_catchment %>% 
  ...
  scale_fill_manual(values=c("#D48F90FF", "#08519C", "#006D2C"), name="Catchment \n Region") +
  geom_sf_label(data = wrf_labs_sf, aes(label = paste("Plant", wrf, sep = " ")), size = 4) +
...
ggsave((here("figures/wrf_plot.tiff")))
plot(wrf_plot)
