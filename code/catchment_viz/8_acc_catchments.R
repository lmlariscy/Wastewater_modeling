...
wrf_catchment = st_read(here("data/wrf_catchment_simple/wrf_catchment_simple.shp"))
...
tiff(here("figures/wrf_plot.tiff", units="in", width=6, height=5, res=600, compression = 'lzw'))
plot(wrf_plot)
dev.off()
