...
```{r}
cv_vl_n6_metrics_sum <- vl_n6_metrics_sum %>% mutate(.config="vl_n6",
                                                  feature="vl")
cv_vl_n5_metrics_sum <- vl_n5_metrics_sum %>% mutate(.config="vl_n5",
                                                  feature="vl")
cv_vl_n4_metrics_sum <- vl_n4_metrics_sum %>% mutate(.config="vl_n4",
                                                  feature="vl")
cv_vl_n3_metrics_sum <- vl_n3_metrics_sum %>% mutate(.config="vl_n3",
                                                  feature="vl")
cv_vl_n2_metrics_sum <- vl_n2_metrics_sum %>% mutate(.config="vl_n2",
                                                  feature="vl")
cv_vl_n1_metrics_sum <- vl_n1_metrics_sum %>% mutate(.config="vl_n1",
                                                  feature="vl")

cv_metrics_vl_sum <- rbind(cv_vl_n1_metrics_sum,
                       cv_vl_n2_metrics_sum,
                       cv_vl_n3_metrics_sum,
                       cv_vl_n4_metrics_sum,
                       cv_vl_n5_metrics_sum,
                       cv_vl_n6_metrics_sum)
...
saveRDS(n6_train_compare,here(
  "data/processed_data/rand_forest/vl_n6_train_predictions.rds"))

saveRDS(n6_train_rsq,here(
  "data/processed_data/rand_forest/vl_n6_train_rsq.rds"))

saveRDS(n6_train_rmse,here(
  "data/processed_data/rand_forest/vl_n6_train_rmse.rds"))
```
...
saveRDS(n6_full_compare,here(
  "data/processed_data/rand_forest/vl_n6_full_predictions.rds"))
```
