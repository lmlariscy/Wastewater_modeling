...
ggsave(here("figures/linear_reg/metrics/rmse_compare.png"))
```
...
all_n6_train_fig <- all_n6_train_predictions %>% 
  ...
  annotate("text", label="Predicted", x=18500, y=3750, color="#dd1010", size=4) +
  annotate("text", label="Observed", x=18500, y=4000, color="#190cc5", size=4) +
...
all_n6_test_fig <- all_n6_test_predictions %>% 
  ...
  annotate("text", label="Predicted", x=19050, y=5650, color="#dd1010", size=4) +
  annotate("text", label="Observed", x=19050, y=6000, color="#190cc5", size=4) +
  ylab("Weekly reported cases") +
  xlab("Week") +
  ggthemes::theme_clean() +
  theme(axis.title = element_text(face = "bold",size = 12)) 
