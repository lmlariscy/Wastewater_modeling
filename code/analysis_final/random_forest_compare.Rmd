...
all_n6_train_fig <- all_n6_train_predictions %>% 
  ggplot(aes(x=week)) +
  geom_line(aes(y=prediction), color = "#dd1010") +
  geom_point(aes(y=prediction), color = "#dd1010") +
  geom_ribbon(aes(ymin=pred_lower, ymax=pred_upper), fill = "#dd1010", alpha = 0.3) +
  geom_line(aes(y=actual), color = "#190cc5") +
  geom_point(aes(y=actual), color = "#190cc5") +
  annotate("text", label=all_n6_train_rsq_round, x=18950, y=1300, size=4) +
  annotate("text", label="Predicted", x=18500, y=1220, color="#dd1010", size=4) +
  annotate("text", label="Observed", x=18500, y=1300, color="#190cc5", size=4) +
...
all_n6_test_fig <- all_n6_test_predictions %>% 
  ...
  annotate("text", label="Predicted", x=19050, y=1410, color="#dd1010", size=4) +
  annotate("text", label="Observed", x=19050, y=1500, color="#190cc5", size=4) +
  ylab("Weekly reported cases") +
  xlab("Week") +
  ggthemes::theme_clean() +
  theme(axis.title = element_text(face = "bold",size = 12)) 
