...
all_n2_test_fig <- all_n2_test_predictions %>% 
  ...
  geom_line(aes(y=actual), color = "#003e99") +
  geom_point(aes(y=actual), color = "#003e99", shape = 16) +
  annotate("text", label=all_n2_test1_rsq_round, x=19095, y=5000, size=4) +
  annotate("text", label=all_n2_test2_rsq_round, x=19330, y=5000, size=4) +
  annotate("text", label="Predicted", x=19045, y=4700, color="#FB6A4A", size=4) +
  annotate("text", label="Observed", x=19045, y=5000, color="#003e99", size=4) +
  ylab("Weekly cases per 100,000") +
  #xlab("Week") +
  geom_vline(xintercept = 19115, linetype = 2) +
  geom_hline(yintercept = 6000, alpha = 0) +
  ggthemes::theme_clean() +
  theme(axis.title = element_text(face = "bold",size = 12),
        axis.title.x = element_blank()) 
...
df_n2_test_fig <- df_n2_test_predictions %>% 
  ...
  geom_line(aes(y=actual), color = "#003e99") +
  geom_point(aes(y=actual), color = "#003e99", shape = 16) +
  annotate("text", label=df_n2_test1_rsq_round, x=19095, y=6000, size=4) +
  annotate("text", label=df_n2_test2_rsq_round, x=19330, y=6000, size=4) +
