...
predictions_df_n3_sum <- predictions_df_n3 %>%
  ...
  summarize(
    ...
    lower = prediction_avg - 1.96*error,
    upper = prediction_avg + 1.96*error) 

#calculate spearman rank correlation
df_n3_cor <- cor(predictions_df_n3$actual,
         predictions_df_n3$prediction,
         method = "spearman")

rsq(predictions_df_n3, truth=actual, estimate=prediction)
...
#calculate spearman rank correlation
df_n3_cor_test <- cor(predictions_df_n3_test$actual,
         predictions_df_n3_test$prediction,
         method = "spearman")

rsq(predictions_df_n3_test, truth=actual, estimate=prediction)
