...
saveRDS(n6_train_compare,here(
  "data/processed_data/linear_reg/df_n6_train_predictions.rds"))

saveRDS(n6_train_rsq,here(
  "data/processed_data/linear_reg/df_n6_train_rsq.rds"))

saveRDS(n6_train_rmse,here(
  "data/processed_data/linear_reg/df_n6_train_rmse.rds"))
```
...
saveRDS(n6_test_compare,here(
  "data/processed_data/linear_reg/df_n6_test_predictions.rds"))

saveRDS(n6_test_rsq,here(
  "data/processed_data/linear_reg/df_n6_test_rsq.rds"))

saveRDS(n6_test_rmse,here(
  "data/processed_data/linear_reg/df_n6_test_rmse.rds"))
```
...
saveRDS(n6_full_compare,here(
  "data/processed_data/linear_reg/df_n6_full_predictions.rds"))
```
