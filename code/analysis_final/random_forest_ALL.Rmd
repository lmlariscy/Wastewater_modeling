...
collect_predictions(cv_all_n6) %>% mutate(prediction = 10^(.pred),
                                          observed = 10^(cases.reported)) %>% 
...
```{r}
cv_all_n6_metrics_sum <- all_n6_metrics_sum %>% mutate(.config="all_n6",
                                                  feature="combined")
cv_all_n5_metrics_sum <- all_n5_metrics_sum %>% mutate(.config="all_n5",
                                                  feature="combined")
cv_all_n4_metrics_sum <- all_n4_metrics_sum %>% mutate(.config="all_n4",
                                                  feature="combined")
cv_all_n3_metrics_sum <- all_n3_metrics_sum %>% mutate(.config="all_n3",
                                                  feature="combined")
cv_all_n2_metrics_sum <- all_n2_metrics_sum %>% mutate(.config="all_n2",
                                                  feature="combined")
cv_all_n1_metrics_sum <- all_n1_metrics_sum %>% mutate(.config="all_n1",
                                                  feature="combined")
