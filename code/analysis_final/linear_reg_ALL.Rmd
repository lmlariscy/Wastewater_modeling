...
bootstrap_all_n6_results <- fit_resamples(all_workflow_n6, 
...
#run bootstrapping and save predictions
bootstrap_all_n6_results_test <- fit_resamples(all_workflow_n6, 
...
#run bootstrapping and save predictions
bootstrap_all_n6_results_full <- fit_resamples(all_workflow_n6, 
